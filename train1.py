...
class GAN(object):
    ...
    def train_on_batch(self, epochs):
        ...
        for epoch in range(epochs):
            ...
            color_output = self.retinex_SSR(train_noise)#SSR,MSR,MSRCR

            #另一种情况，2个都使用
            # color_output2 = self.color_compensation(train_noise)
            # color_output = self.retinex_SSR(color_output2 ）
            ...
            #融合
            enhanced_image =  tf.math.multiply(conv17_output, color_output)#1相乘
            #2最大值融合
